...
Confirm every registered secondmate home carries it before clearing any machine-wide credential copies; [`docs/configuration.md`](../../../docs/configuration.md) owns the mechanism, the per-home check, and the confirmation signal.
