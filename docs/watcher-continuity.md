...
`state/.watch-triage.log` remains the watcher's own bounded debug log for absorbed wakes and its routine housekeeping notes, and carries no lifecycle semantics.
