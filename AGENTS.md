...
state/               volatile runtime signals; gitignored
  ...
  .hash-* .count-* .stale-* .stale-since-* .paused-* .wedge-escalations-* .step-activity-* .step-progress-* .seen-* .hb-surfaced-* .last-* .heartbeat-streak   watcher internals; never touch
